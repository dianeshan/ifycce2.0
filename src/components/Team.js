    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p>
                    Timothy has 10+ years of industry experience in technical sales, business development,
                    and product management focus on machine learning and cloud computing. He led multiple
                    product developments, executions, and launches ranging from $10M to $100M run rates.
                    Timothy is passionate about learning and building new products and a believer in giving back
                    to the community. On a personal note, Timothy is a happy father and a family man who still
                    tries to be better in both. He is also a big fan of college football and loves skiing and scuba diving.
                </p>
                <a href="https://www.linkedin.com/in/timothy-ma-6759b138/" target="_blank" rel="noreferrer">LinkedIn profile</a>
            </Modal.Body>
            <Modal.Footer>
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p>
                    Nina Tsai has 20+ years of industry experience in Data Science and Analytics fields. She
                    is
                    currently a product analytics manager at Facebook, responsible for Ads product and
                    operations. Prior to Facebook, she held positions at eBay, Safeway, CVS, and a startup,
                    to
                    drive business success through the use of data and analytics. Nina is very passionate
                    about
                ...
                <a href="https://www.linkedin.com/in/nina-tsai/" target="_blank" rel="noreferrer">LinkedIn profile</a>
            </Modal.Body>
            <Modal.Footer>
                <Button onClick={props.onHide}>Close</Button>
            </Modal.Footer>
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p>
                    For the past decade, Dr. Daniel Ding is a tech lead and passionate AI practitioner in the
                    crossfire of cutting edge software and hardware design. From microprocessors to SaaS, he
                    contributed to and led projects that impact the design, analysis and optimization of
                    high-end computing systemss.
                    Inspired by the 2020 global pandemic and educators around the world, Daniel has found a
                    new
                    passion to give back to the community and prepare the young generation for the future
                    job
                    market. Daniel received his PhD degree in ECE at the University of Texas at Austin and
                    has
                    authored/co-authored more than 50 peer-reviewed publications, including best paper
                    awards
                    and the highly prestigious ACM SIGDA Best PhD Dissertation Award in 2011.
                </p>
                <a href="https://www.linkedin.com/in/duoding" target="_blank" rel="noreferrer">LinkedIn profile</a>
            </Modal.Body>
            <Modal.Footer>
                <Button onClick={props.onHide}>Close</Button>
            </Modal.Footer>
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p>
                    Kedi Mei has 16+ years of experience in the Traffic Engineering field. She is currently a
                    senior project engineer at BKF Engineers. She has managed numerous public transportation
                    projects, as well as private development projects within the bay area and southern
                    California. Some of the projects include BART extension in Fremont, VTA light rail
                    extension
                    in San Jose, Facebook campus, Gerald Desmond Bridge in Long Beach, and various highway
                    improvement projects. Kedi is passionate to provide support by sharing her experiences
                    to
                    young engineers. She was one of the mentors in BKF Engineers’ Women in Engineering
                    Resource
                    Group. Outside of work, she is one of the spiritual parents at Young Adult Fellowship at
                    her
                    home church. She treasures her relationship with the young generation and enjoys sharing
                    her
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p>
                    Liju Huang was a Sr. Visual Media Designer on an Enterprise Learning Organization of a
                    human
                    resources management software and services industry for 25+ years. Liju has been the
                    lead
                    designer in the areas of user interface and interaction design for many micro-learning
                    templates, websites, menus, and learning management systems.
                    Liju’s expertise is to combine user experience, brand, business and functional
                    requirements
                    with concise visual design to different products, services and platforms.
                </p>
            </Modal.Body>
            <Modal.Footer>
                <Button onClick={props.onHide}>Close</Button>
    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                <p>
                    Dr. Cheng is a Sr. Hardware Engineer in Amazon Lab126 with eight years of industry
                    experience
                    working on laser, LED and consumer electronics. He has a PhD in Electrical and Computer
                    Engineering from the University of Illinois at Urbana Champaign.
                    Dr. Cheng receives guidance from many great mentors in his career. In the spirit of
                    giving
                    back, he has been mentoring young people to explore their passion and develop positive
                    attitudes toward work and life. Outside of work he enjoys spending time with his family
                    as
                                ...
                                <Row>
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow(true)}>
                                            <img className="headshot" src={timothyma} alt="Timothy's Headshot" /></Button>
                                        <h6>Timothy Ma</h6>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow2(true)}>
                                            <img className="headshot" src={ninatsai} alt="Nina's Headshot" /></Button>
                                        <h6>Nina Tsai</h6>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow3(true)}>
                                            <img className="headshot" src={danielding} alt="Daniel's Headshot" /></Button>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow4(true)}>
                                            <img className="headshot" src={kedimei} alt="Kedi's Headshot" /></Button>
                                        <h6>Kedi Mei</h6>
                                ...
                                <Row>
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow5(true)}>
                                            <img className="headshot" src={lijuhuang} alt="Liju's Headshot" /></Button>
                                        <h6>Liju Huang</h6>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow6(true)}>
                                            <img className="headshot" src={donaldcheng} alt="Donald's Headshot" /></Button>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow7(true)}>
                                            <img className="headshot" src={lindalee} alt="Linda's Headshot" /> </Button>
                                        <h6>Linda Lee</h6>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow8(true)}>
                                            <img className="headshot" src={kunzan} alt="Kun's Headshot" /></Button>
                                        <h6>Dr. Kun Zan</h6>
                                ...
                                <Row>
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow9(true)}>
                                            <img className="headshot" src={stevexi} alt="Steve's Headshot" /></Button>
                                        <h6>Dr. Steve Xi</h6>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow10(true)}>
                                            <img className="headshot" src={johncheung} alt="John's Headshot" /></Button>
                                        <h6>John Cheung</h6>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow11(true)}>
                                            <img className="headshot" src={chinjenchiang} alt="Chin-Jen's Headshot" /></Button>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow12(true)}>
                                            <img className="headshot" src={bindu} alt="Bindu's Headshot" /></Button>
                                ...
                                <Row>
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow13(true)}>
                                            <img className="headshot" src={paulpetrus} alt="Paul's Headshot" /></Button>
                                    ...
                                    <Col sm="12" md="3" className="text-center">
                                        <Button variant="link" onClick={() => setModalShow14(true)}>
                                            <img className="headshot" src={woojin} alt="Woojin's Headshot" /></Button>
                                        <h6>Woojin Kim</h6>
