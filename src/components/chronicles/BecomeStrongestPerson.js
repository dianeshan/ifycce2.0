...
import mehdi from "../../images/chronicles/mehdiKargar.png";
import reflection from "../../images/chronicles/selfReflection.png";
import question from "../../images/chronicles/question.png";
            ...
            <Container>
              <Row>
                ...
                <Col md="8">
                  <br></br>
                  <p>
                    Dr. Mehdi Kargar is currently the CEO and co-founder of
                    Maxterial, Inc, a material science technology company. Dr.
                    Kargar has a Ph.D. in mechanical engineering from Virginia
                    Tech., where he was working on advanced coating and
                    biomaterials. In his company, he aims to provide affordable
                    metallic coating to protect the surfaces against wear and
                    corrosion while reducing the usage of dangerous chemicals.
                    Dr. Kargar encourages young people to live a life, rather
                    than just following the track and trend that everybody else
                    does.
                  </p>
                  <hr className="seperate-line" />
                  <DropDown
                    title={
                      "How would you describe what you're doing now professionally?"
                    }
                    content={
                      "My current job is the co-founder of a seven-year-old material science startup called Maxterial. The majority of my job is dealing with investors, senior management, shareholders as well as customers. Also, I must put the vision for the company on where it's going to go, and how those directions are going to enable something good for humans while enabling a good return on investment for shareholders."
                    }
                  />
                  <hr className="seperate-line" />
                  <DropDown
                    title={"What is the driving force behind your work?"}
                    content={
