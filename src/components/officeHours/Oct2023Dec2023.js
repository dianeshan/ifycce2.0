...
import { tracks6 } from "../../data/tracksOct23Dec23";

import logo from "../../images/CCELogo_square.png";

class OfficeHours6 extends Component {
  render() {
    return (
      <div className="all-content">
        <div className="content-wrap">
          ...
          <div className="main-page">
            <div className="inner">
              <Button color="primary" href="/officehours5">
                Previous
              </Button>{" "}
            ...
            <h1 className="inner">Oct 2023 - Dec 2023</h1>
            <AudioPlayer />
            {tracks6.map((track, idx) => (
              <div key={idx}>
