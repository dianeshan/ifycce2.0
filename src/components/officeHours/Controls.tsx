...
interface ControlsProps {
  ...
  tracks: Track[];
  trackIndex: number;
  setTrackIndex: (value: React.SetStateAction<number>) => void
  setCurrentTrack: (tracks: Track) => void;
  handleNext: () => void;
}

const Controls = (props: ControlsProps) => {
  const { audioRef, progressBarRef, duration, setTimeProgress, setCurrentTrack, setTrackIndex, handleNext, trackIndex, tracks } = props;
