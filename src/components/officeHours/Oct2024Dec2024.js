...
import { tracks10 } from "../../data/tracksOct24Dec24";

import logo from "../../images/CCELogo_square.png";

class OfficeHours10 extends Component {
  render() {
    return (
      <div className="all-content">
        <div className="content-wrap">
          ...
          <div className="main-page">
            ...
            <h1 className="inner">Oct 2024 - Dec 2024</h1>
            <AudioPlayer />
            {tracks10.map((track, idx) => (
              <div key={idx}>
