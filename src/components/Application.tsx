...
import banner from "../assets/application/M_bannerImage2.jpg";
import timeline from "../assets/application/TimeLine2023.png";
import soaringeaglestory from "../assets/application/SoaringEagleStory.png";
import cloud from "../assets/application/Cloud.png";
import web from "../assets/application/Web.png";
